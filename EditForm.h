...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			// WordTextBox
			// 
			this->WordTextBox->BackColor = System::Drawing::Color::WhiteSmoke;
			...
			this->label2->Text = L"Edit type";
			// 
			// TypeTextBox
			// 
			this->TypeTextBox->BackColor = System::Drawing::Color::WhiteSmoke;
			...
			this->label3->Click += gcnew System::EventHandler(this, &EditForm::label3_Click);
			// 
			// MeaningTextBox
			// 
			this->MeaningTextBox->BackColor = System::Drawing::Color::WhiteSmoke;
			...
			// ExRichTextBox
			// 
			this->ExRichTextBox->BackColor = System::Drawing::Color::WhiteSmoke;
			...
			// AddMeaningbtn
			// 
			this->AddMeaningbtn->BackColor = System::Drawing::Color::WhiteSmoke;
			...
			// EditWordbtn
			// 
			this->EditWordbtn->BackColor = System::Drawing::Color::WhiteSmoke;
			...
			this->richTextBox1->Location = System::Drawing::Point(108, 212);
			this->richTextBox1->Name = L"richTextBox1";
			this->richTextBox1->Size = System::Drawing::Size(384, 66);
			this->richTextBox1->TabIndex = 10;
			this->richTextBox1->Text = L"QAMROSH MAQSOOD    SHAZAIB SHAFIQ";
			...
			this->ClientSize = System::Drawing::Size(972, 443);
